...
inline_btn_2 = InlineKeyboardButton('Proxifier', url = "http://194.67.108.38:5555/Proxifier.exe",  callback_data='button2')
...
inline_btn_14 = InlineKeyboardButton('Учетка VPN',  callback_data='button14')
inline_kb14 = InlineKeyboardMarkup().add(inline_btn_14)
inline_btn_15 = InlineKeyboardButton('Telega',  callback_data='button15')
inline_kb15 = InlineKeyboardMarkup().add(inline_btn_15)
inline_btn_16= InlineKeyboardButton('CORE Tor', url = "http://194.67.108.38:5555/core_Tor.rar", callback_data='button16')
inline_kb16= InlineKeyboardMarkup().add(inline_btn_16)
inline_btn_17= InlineKeyboardButton('Установка Ядра Tor', callback_data='button17')
inline_kb17= InlineKeyboardMarkup().add(inline_btn_17)
inline_btn_18= InlineKeyboardButton('Proxifier keys',  callback_data='button18')
inline_kb18= InlineKeyboardMarkup().add(inline_btn_18)
inline_btn_19= InlineKeyboardButton('Настройка Proxi',  url = "http://194.67.108.38:5555/nastroika.ppx", callback_data='button19')
inline_kb19= InlineKeyboardMarkup().add(inline_btn_19)
...
inline_kb_full.row(inline_btn_14, inline_btn_15)
inline_kb_full.row(inline_btn_2, inline_btn_18, inline_btn_19)
...
inline_kb_full.row(inline_btn_16, inline_btn_17)